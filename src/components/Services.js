        ...
        <div className={styles.right_section}>
          <div className={styles.container}>
            <div className={styles.item}>
              ...
              <h3>Développement</h3>
              <p>
                Je possède une solide compréhension des langages tels que HTML,
                CSS et JavaScript. Je construits des applications web avec React
                et NextJS.
              </p>
            </div>
            <div className={styles.item}>
              ...
              <h3>Web Design</h3>
              <p>
                Mon approche créative alliée à ma maîtrise des outils de design
                tels que Figma et Photoshop, me permettent de créer des
